...
namespace _03_Operators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // && operator both sides of the comparison have to be true in order to deliver a true bool
            int x = 13;
            bool test = x < 44 && x > 10;
            Console.WriteLine(test);
            

            //|| one side of the comparison has to be true in order to deliver a true bool
            int y = 10;
